...
Students will need one Common Data Service (CDS) environment each to complete the course work. Environments can be provisioned as trial environments by the students during class or they can be provisioned prior to the delivery with credentials handed over to the students prior to the first exercise.
...
<tr class="even">
<td>3:15 – 4:00 </td>
<td>M08 –Testing and Documentation
<ul>
<li>
Testing apps
</li>
...
<tr class="odd">
<td>8:00 – 8:15 </td>
<td>Scenario Overview 
<ul>
<li>
Introduce overall scenario
</li>
<li>
Call out discussion points
</li>
<li>
Point students to lab resources
</li>
</ul></td>
</tr>
<tr class="even">
<td>8:15 – 9:15 </td>
<td>Lab 01 – Design Solution 
<ul>
<li>
...
<li>
Provide students with 45 mins to 1 hour to work on lab
</li>
</ul></td>
</tr>
<tr class="odd">
...
<tr class="even">
<td>9:30 – 10:45</td>
<td>Lab 02 – Data Model and Model App 
<ul>
<li>
Review Discussion Points from Lab 01
</li>
<li>
Introduce the Lab 02 scenario
</li>
<li>
Call out any potential pain points to be aware of
</li>
<li>
Provide students with 45 mins to 1 hour to work on lab
</li>
...
<tr class="even">
<td>11:00 – 12:00</td>
<td>Lab 03 – Canvas Apps 
<ul>
<li>
Review Discussion Points from Lab 02
</li>
<li>
Introduce the Lab 03 scenario
</li>
<li>
Call out any potential pain points to be aware of
</li>
<li>
Provide the rest of the morning to work on Lab 03
</li>
</ul></td>
</tr>
<tr class="odd">
...
<tr class="even">
<td>1:00 – 1:45</td>
<td>Lab 04 – BPF &amp; Business Rules 
<ul>
<li>
Review Discussion Points from Lab 03
</li>
<li>
Introduce the Lab 04 scenario
</li>
<li>
Call out any potential pain points to be aware of
</li>
<li>
Provide students with 30 to 45 mins to work on lab
</li>
</ul></td>
</tr>
<tr class="odd">
...
<tr class="even">
<td>2:00 – 2:45</td>
<td>Lab 05 – Power Automate 
<ul>
<li>
Review Discussion Points from Lab 04
</li>
<li>
Introduce the Lab 05 scenario
</li>
<li>
Call out any potential pain points to be aware of
</li>
...
<ul>
<li>
Review Discussion Points from Lab 05
</li>
<li>
Introduce the Lab 06 scenario
</li>
<li>
Call out any potential pain points to be aware of
</li>
...
<tr class="even">
<td>4:00 – 4:45</td>
<td>Lab 07 – Test and Deploy
<ul>
<li>
Review Discussion Points from Lab 06
</li>
<li>
Introduce the Lab 07 scenario
</li>
<li>
Call out any potential pain points to be aware of
</li>
...
> [!IMPORTANT]
> Students will need to have completed all the exercises in Lab 2 prior to working on this lab.
...
> [!IMPORTANT]
> Students need to complete the exercises in Lab 02 prior to working on this lab. The business rules and business process flows build on the items data model created in Lab 02.
...
> [!IMPORTANT]
> Students need to complete the exercises in both Lab 02 and Lab 04 prior to working on this lab. The approval flows that you will be creating build on the data model created in lab 02 and the additional fields added in lab 04.
