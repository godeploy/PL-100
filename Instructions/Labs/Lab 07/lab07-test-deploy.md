...
[Lab 07 – Test Deploy 1](#lab-07-test-deploy)
...
[**Exercise 1: Create security roles** 3](#exercise-1-create-security-roles)

[**Task 1: Create security roles** 3](#task-1-create-security-roles)

[**Exercise 2: Solution checker** 4](#exercise-2-solution-checker)

[**Task 1: Run solutions checker** 4](#task-1-run-solutions-checker)

[**Exercise 3: Use test studio** 4](#exercise-3-use-test-studio)

[**Task 1: Create test case** 4](#task-1-create-test-case)

[**Exercise 4: Import export** 6](#exercise-4-import-export)

[**Task 1: Export solution** 6](#task-1-export-solution)

[**Task 2: Create new environment and import solution** 6](#task-2-create-new-environment-and-import-solution)
...
![Add security role - screenshot](./media/image1.png)
...
![Read privileges - screenshot](./media/image2.png)
...
![Security role privileges - screenshot](./media/image3.png)
...
![Run solution checker - screenshot](./media/image4.png)
...
![View solution check results - screenshot](./media/image5.png)
...
![Edit application - screenshot ](./media/image6.png)
...
![Edit formula - screenshot](./media/image7.png)
...
![Export solution - screenshot](./media/image8.png)
...
![Check environment status - screenshot](./media/image9.png)
...
![Select solution file - screenshot](./media/image10.png)
